...
* <kbd>M</kbd><kbd>T</kbd><kbd>D</kbd><kbd>H</kbd> = Multi-environment. <kbd>M</kbd>ain, <kbd>T</kbd>est, <kbd>D</kbd>ev, <kbd>H</kbd>ooks networks are supported.
...
* [XRPL.org Explorer](https://livenet.xrpl.org) 💫 [<kbd>M</kbd>](https://livenet.xrpl.org)[<kbd>T</kbd>](https://testnet.xrpl.org)[<kbd>D</kbd>](https://devnet.xrpl.org)
  XRPL.org's explorer src: [ripple/explorer](https://github.com/ripple/explorer) ⭐ 241 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-16
...
*See also [XRPL Developer Tools](#xrpl-developer-tools).*
...
* [OtterServices' Validator Guide](https://github.com/OtterServices/RippledValidatorGuide/) ⭐ 4 | 🐛 0 | 📅 2021-03-27 Explains from start to finish if you're not even running a node.
...
[`rippled`](https://github.com/ripple/rippled/) ⭐ 5,190 | 🐛 972 | 🌐 C++ | 📅 2026-09-16 *This is the core of the XRPL*, it's a peer to peer network daemon.
...
* [Node Configurator](https://xrplf.github.io/xrpl-node-configurator/) - 🪄✨ This wizard will walk you through configuring a node!
  If you want to go full custom. The [shipped, example configuration file](https://github.com/ripple/rippled/blob/7bd5d51e4e4e76a5547051d30b330739618eddb0/cfg/rippled-example.cfg) ⭐ 5,190 | 🐛 972 | 🌐 C++ | 📅 2026-09-16
...
* [rippled Docker container (node)](https://github.com/WietseWind/docker-rippled) ⭐ 75 | 🐛 1 | 🌐 Shell | 📅 2026-08-07 - [Docker hub](https://hub.docker.com/r/xrptipbot/rippled/)
* [rippled Docker container (validator)](https://github.com/WietseWind/docker-rippled-validator) ⭐ 24 | 🐛 0 | 🌐 Shell | 📅 2022-01-04 - [Docker hub](https://hub.docker.com/r/xrptipbot/rippledvalidator/)
...
* [Running an XRPL Validator on a RPi4](https://write.as/dvilela/running-an-xrpl-validator-on-a-raspberry-pi-4)
  ...
  [here](https://github.com/derkomai/xrpldRaspberryPi) ⭐ 4 | 🐛 0 | 🌐 Shell | 📅 2021-03-03. This methodology can apply to compiling `rippled`
...
* [ripple-server mailing list](https://groups.google.com/forum/#!forum/ripple-server/) This email list announces releases, and other info
  for any [node](https://xrpl.org/rippled-server-modes.html) operator. *Old-school*, but effective for widespread announcements!
...
* [`xrpl.ws`](https://xrpl.ws) *TLD isn't as stable as .com*, use `xrplcluster.com` instead.

# XRPL Developer Tools

* [xrp.fans](https://xrp.fans/) *[Source](https://github.com/WietseWind/rippled-ws-client-dashboard) ⭐ 7 | 🐛 21 | 🌐 Vue | 📅 2022-12-07*- Dashboard Debugging & Development for the XRPL
* [XRPL Attendify](https://github.com/JustAnotherDevv/AttendifyXRPL) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2023-06-23 - Mint, distribute NFTs and verify attendance at a wide range of events and activities. Includes example implementation for ExpressJS API
...
* [**xrpl.js**][#xrpl.js] - JavaScript / TypeScript *maintained by [XRPLF][#xrplf]*
* [**xrpl4j**][#xrpl4j] Java *maintained by [XRPLF][#xrplf]*
* [**xrpl-py**][#xrpl-py]
  [![xrpl-py Documentation Status](https://readthedocs.org/projects/xrpl-py/badge)](https://xrpl-py.readthedocs.io/)
  Python *maintained by [XRPLF][#xrplf]*
...
* [xrbp](https://github.com/DevNullProd/XRBP) ⭐ 11 | 🐛 0 | 🌐 Ruby | 📅 2020-04-23 - Ruby :: [rubydoc](https://www.rubydoc.info/gems/xrbp)
* [node-red-contrib-xrpl](https://github.com/xrpinnovations/node-red-contrib-xrpl) ⭐ 7 | 🐛 9 | 🌐 HTML | 📅 2023-03-06 <a name="code/node-red-contrib-xrpl"></a> - [Node-RED](https://nodered.org) Modules for XRPL
...
* [WietseWind/xrp-vanity-generator](https://github.com/WietseWind/xrp-vanity-generator) ⚠️ Archived - Using [ripple-keypairs](https://github.com/ripple/ripple-keypairs) ⚠️ Archived,
  part of [xrpl.js](https://github.com/XRPLF/xrpl.js) ⭐ 1,327 | 🐛 235 | 🌐 TypeScript | 📅 2026-09-15
...
* [ledgerjs](https://github.com/LedgerHQ/ledgerjs) ⚠️ Archived - The SDK for interacting
...
* [xrpl-rust](https://github.com/sephynox/xrpl-rust) ⭐ 41 | 🐛 201 | 🌐 Rust | 📅 2026-09-10: Rust
...
* [ripple-haskell](https://github.com/singpolyma/ripple-haskell/) ⭐ 2 | 🐛 1 | 🌐 Haskell | 📅 2015-07-04: Haskell
...
* [XRPL-monitor-ESP32](https://github.com/derkomai/XRPL-monitor-ESP32) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2019-02-25 - Using an ESP32 (an arduino with wifi),
...
* [CoinClub Framework](https://github.com/QCloud-DevOps/CoinClub_Framework) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2022-03-17 -  A Python Library for multiple Blockchains.
...
* [CodeShark/RippleGen](https://github.com/CodeShark/RippleGen/) ⭐ 26 | 🐛 3 | 🌐 C++ | 📅 2013-04-11 - C++/Boost over 8 years old, need to test it!
...
A classic address - Starts with `r` - is an account on XRPL, with an optional tag. [*via*](https://xrpl.org/accounts.html#addresses)

[**X-address Info**](https://xrpaddress.info) Everything you wanted to know about X-address format.

* [xrpl-tagged-address-codec](https://github.com/xrp-community/xrpl-tagged-address-codec) ⭐ 24 | 🐛 15 | 🌐 TypeScript | 📅 2023-11-03 - js package for encoding/decoding X-address format
...
* [Spend The Bits](https://spendthebits.com/) 📱 App that let's you save and send Bitcoin *instantly* by leveraging the XRPL
  and [issued currencies](https://xrpl.org/issued-currencies-overview.html).

## Ideas

* [XRPL Ideas (GitHub Discussions)](https://github.com/intelliot/xrpl-ideas/discussions) ⭐ 8 | 🐛 0 | 📅 2021-10-03 Forum where you can share XRPL ideas, and read ideas by others.
...
* [**Ledger**][#ledger.com] - Ledger is a hardware wallet manufacturer. Their
  ...
  [ledgerjs](https://github.com/LedgerHQ/ledgerjs) ⚠️ Archived SDK. [LedgerHQ/app-xrp](https://github.com/LedgerHQ/app-xrp) ⭐ 19 | 🐛 7 | 🌐 C | 📅 2026-09-15 is the source for the Ledger XRP app.
* 🌟[**XUMM**][#xumm.app] 📱 *Pronounced "sum"* - XUMM is a self-custodial wallet for
  ...
  [XRPL-Labs/XUMM-App](https://github.com/XRPL-Labs/XUMM-App) ⭐ 117 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-27 is the source of
...
* [paystring-cli](https://github.com/PayString/paystring-cli) ⚠️ Archived Query a PayString from the commandline.
* [payid-lambda](https://github.com/xpring-eng/payid-lambda) ⚠️ Archived An AWS Lambda for serving up a PayString.

# Interledger

* [**Awesome Interledger**](https://github.com/vhpoet/awesome-ilp) ⭐ 7 | 🐛 0 | 📅 2018-04-04 [![awesome-ilp](https://awesome.re/badge.svg)](https://github.com/vhpoet/awesome-ilp) ⭐ 7 | 🐛 0 | 📅 2018-04-04

# XRPL Cross Blockchain

XRP is utilized to connect other block chains to the XRPL.
This is an intrinsic property of XRP, since it's a [scarce resource](https://github.com/ripple/rippled/commit/f0e3383856a8923e55b0f10e7822de9031b7159e) ⭐ 5,190 | 🐛 972 | 🌐 C++ | 📅 2026-09-16
...
* [Flare Networks](https://flare.xyz) - a blockchain that uses <abbr title="Flare Consensus Protocol">[FCP](https://flare.xyz/flare-consensus-protocol-an-explainer/)</abbr>
